...
You have received a new inquiry the details are as follows:<br /><br />
...
A copy of this message can also be found in your <a style='color:#<?=$email_hex?>' href='http://www.<?=$site_url?>/admin'>Command Centre</a>.<br /><br />
<?
include('footer.php');
